      ...
      <div className="about">
        <div>
          ...
          <div className="about-elevator-pitch">
            <h1 className="about-elevator-pitch-title" onClick={ this.toggleDrop }>
            ...
            <div className={ this.state.aboutExpandClass }>
              ...
              <p className="about-elevator-pitch-paragraph">I grew into a role of improving our procedures and data with technology and am most proud of the management system I developed for our research visit summaries (<a href="https://github.com/fonsecapeter/jarvs">Jarvs</a>). While working on these projects, I realized that my greatest services to the study came through programming. Not only was I making my co-workers lives easier, I was helping our research participants recieve better care.</p>
